...
namespace BuberDinner.Infrastructure.Migrations
{
    ...
    [Migration("20230305125724_InitialCreate")]
            ...
            modelBuilder.Entity("BuberDinner.Domain.Menu.Menu", b =>
                {
                    ...
                    b.OwnsMany("BuberDinner.Domain.Menu.MenuSection", "Sections", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                            ...
                            b1.OwnsMany("BuberDinner.Domain.Menu.MenuItem", "Items", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier")
                    ...
                    b.OwnsOne("BuberDinner.Domain.Menu.ValueObjects.AverageRating", "AverageRating", b1 =>
                        {
                            b1.Property<Guid>("MenuId")
                                .HasColumnType("uniqueidentifier");
